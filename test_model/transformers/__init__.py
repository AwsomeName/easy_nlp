...
try:
    ...
    _import_structure["models.yjt2"].append("YJT2TokenizerFast")
...
try:
    ...
    _import_structure["models.yjt2"].extend(
        [
            "YJT2ForCausalLM",
...
if TYPE_CHECKING:
    ...
    from .models.yjt2 import YJT2Config, YJT2Tokenizer
    ...
    try:
        ...
        from .models.yjt2 import YJT2TokenizerFast

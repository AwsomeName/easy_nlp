...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="/Users/lc/code/easy_nlp/models/tiny-gpt2", type=str)
    # parser.add_argument("--model_name", default="sshleifer/tiny-gpt2", type=str)
    parser.add_argument("--pre_train", default="/Users/lc/code/easy_nlp/models/tiny-gpt2", type=str)

# https://github.com/yrqUni/unicorn/blob/main/step1_supervised_finetuning/sft/merge.py
# 另外一种merge lora 的方式，参考，保存

"""
follow with https://github.com/tloen/alpaca-lora
"""
